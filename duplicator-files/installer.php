...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220509_bookreview_a9bbdb3fbbd073255589_20220509202300_archive.zip';
	const ARCHIVE_SIZE		 = '28786863';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'a9bbdb3-09202300';
    const SECONDARY_PACKAGE_HASH = 'e790258-09202300';
	const VERSION			 = '1.4.5';
