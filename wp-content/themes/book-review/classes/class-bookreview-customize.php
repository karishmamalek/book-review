...
if ( ! class_exists( 'Book_Review_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since Book Review 1.0
	 */
	class Book_Review_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'bookreview' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'bookreview' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'bookreview' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'bookreview' ),
						'full'    => esc_html__( 'Full text', 'bookreview' ),
					),
				)
			);
			...
			include_once get_theme_file_path( 'classes/class-bookreview-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type( 'Book_Review_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new Book_Review_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'bookreview' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
